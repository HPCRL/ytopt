...
#SBATCH -o conv1d_timing_%j.sout # name of the stdout, using the job number (%j) and the first node (%N)
#SBATCH -e conv1d_timing_%j.serr # name of the stderr, using job and first node values
