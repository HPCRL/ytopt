...
"td_integration_conv2d_nchw_N1_H68_W68_CO256_CI128_KH3_KW3_ST_1_padding_1"
...
"td_integration_conv2d_nchw_N1_H7_W7_CO512_CI512_KH3_KW3_ST_1_padding_1"
...
for dir in "${conv_directories[@]}"; do
  ...
  python3 -W ignore findMin.py | grep -E '^\s*[0-9.]+\s+[0-9.]+\s+[0-9.]+\s+[0-9.]+\s+[0-9.]+\s+[0-9.]+\s+[0-9.]+\s+[0-9.]+\s+[0-9.]+\s+[0-9.]+\s+[0-9.]+\s+[0-9.]+\s+[0-9.]+$' | awk '{print $12}'
